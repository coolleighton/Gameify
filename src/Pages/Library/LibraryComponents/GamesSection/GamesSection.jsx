...
const GamesSection = ({
    ...
    return (
        <div id="gamesSection" className="w-full rounded-2xl mt-24">
            <h1 className="font-extrabold text-center text-[2.5rem] pt-3 mb-6 md:text-7xl xs:text-5xl xs:text-left">
                {heading}
            </h1>
            <Filters
                gameGenre={gameGenre}
            ...
            ></Filters>
            <div className=" grid grid-cols-1 grid-rows-2 gap-8 mb-7 mt-20 lg:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 sm:mr-10">
                {gamesData.map((item) => {
                    return (
                        <GameCard
                            key={item.name}
